  ...
  return _createClass(Fields, [{
    ...
    value: function _handleAddProject(e) {
      ...
      var _this$_targetInputs = this._targetInputs(),
        ...
        descriptionInput = _this$_targetInputs2[1];
      var _this$_getInputsValue = this._getInputsValues(titleInput, descriptionInput),
    ...
    value: function _getInputsValues(titleInput, descriptionInput) {
    ...
    value: function _validateInputsValues(titleValue, descriptionValue) {
      var _assignValidateInputs = (0, _validation_helpers.assignValidateInputs)(titleValue, descriptionValue),
