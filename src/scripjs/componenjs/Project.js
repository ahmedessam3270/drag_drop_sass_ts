...
var Project = exports.Project = /*#__PURE__*/function (_Base) {
  function Project(projectListId, project) {
    var _this;
    _classCallCheck(this, Project);
    _this = _callSuper(this, Project, ["project-item", projectListId, project.id, false]);
  ...
  return _createClass(Project, [{
    ...
    value: function _renderProject() {
      var titleEl = this.element.querySelector(".project_title");
      var descEl = this.element.querySelector(".project_desc");
